...
class Device:
    ...
    def can_access_peer(self, peer: Device) -> bool:
        ...
    def can_direct_cuda_vulkan_interop(self) -> bool:
        ...
    ...
    def is_cuda(self) -> bool:
        ...
    @property
    def cuda_external_memory(self) -> bool:
        ...
    @property
    def cuda_external_semaphore(self) -> bool:
        ...
    @property
    def cuda_id(self) -> int:
        ...
    ...
    def uuid(self) -> str | None:
        ...
    @property
    def vulkan_external_memory(self) -> bool:
        ...
    @property
    def vulkan_external_semaphore(self) -> bool:
        ...
class Entity:
    name: str
    pose: Pose
...
class Scene:
    ...
    def close(self) -> None:
        """
        Terminally close the scene: remove all entities, detach all systems, and
        mark the scene closed. Unlike clear(), a closed scene cannot be reused. Idempotent.
        """
        ...
    @property
