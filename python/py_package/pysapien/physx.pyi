...
class PhysxArticulation:
    ...
    @staticmethod
    def create_pinocchio_model(articulation: PhysxArticulation, gravity = [0, 0, -9.81]) -> sapien.wrapper.pinocchio_model.PinocchioModel:
        ...
...
class PhysxCollisionShapeCylinder(PhysxCollisionShape):
    ...
    def radius(self) -> float:
        ...
class PhysxCollisionShapeHeightField(PhysxCollisionShape):
    def __init__(self, height_field: numpy.ndarray | list | tuple, row_scale: float, column_scale: float, height_scale: float, material: PhysxMaterial | None = None) -> None:
        ...
    def get_column_scale(self) -> float:
        ...
    def get_height_field(self) -> numpy.ndarray:
        ...
    def get_height_scale(self) -> float:
        ...
    def get_row_scale(self) -> float:
        ...
    @property
    def column_scale(self) -> float:
        ...
    @property
    def height_field(self) -> numpy.ndarray:
        ...
    @property
...
class PhysxGpuSystem(PhysxSystem):
    ...
    def __init__(self, device: str = 'cuda') -> None:
        """
        Create a PhysX GPU system.

        The environment-ID declaration is read from `PhysxSceneConfig` and frozen here: PhysX
        bakes the broadphase bit count into the scene at createScene and refuses
        PxActor::setEnvironmentID once an actor is in a scene.
    ...
    def _gpu_set_viewer_articulation_root_pose(
        ...
        ...
    def _gpu_download_articulation_qpos(self, articulation_index: int) -> list[float]:
        ...
    def _gpu_download_articulation_target_qpos(self, articulation_index: int) -> list[float]:
        ...
    def _gpu_download_articulation_target_qvel(self, articulation_index: int) -> list[float]:
        ...
    def _gpu_upload_articulation_qpos(
        self, articulation_index: int, qpos: numpy.ndarray | list[float] | tuple
    ) -> None:
        ...
    def _gpu_upload_articulation_target_qpos(
        self, articulation_index: int, target: numpy.ndarray | list[float] | tuple
    ) -> None:
        ...
